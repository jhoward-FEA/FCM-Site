		...
		<header id="masthead" class="site-header">
			...
			<div class="site-header-main">
				<!-- <div class="site-branding"> -->
					...
					<figure class="fea-logo wp-block-image alignright size-large"><img src="http://fcm/wp-content/uploads/FEA-logo-fullcolor.png" alt="FEA logo" class="wp-image-269" width="256" height="105" /></figure>
