...
//    print_r(get_defined_vars());
    ...
    print render($content['field_overview_of_degree']);
    print render($content['field_potential_occupations']);
    print render($content['field_course_work']);
    print render($content['field_schools']);
    ?>
  </div>
