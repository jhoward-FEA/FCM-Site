...
//drupal_add_js(drupal_get_path('module', 'career_map').'/testData.js');
?>
<div id="page-wrapper"><div id="page">
  ...
  <div id="main-wrapper" class="clearfix"><div id="main" class="clearfix">
    ...
    <div id="content" class="career-content">
        ...
        <canvas id="careerMap" height="600" width="900"></canvas>
       <div id="sidebarText">I am the sidebar text!</div>
...
This is my custom page for the career mapping tool
