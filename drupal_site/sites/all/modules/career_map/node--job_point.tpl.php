...
//    print_r(get_defined_vars());
    ...
    print render($content['field_common_titles']);
    print render($content['field_education_training']);
    print render($content['field_related_credentials']);
    print render($content['field_military']);
    ?>
  </div>
...
drupal_add_js('jQuery(document).ready(function (){
                if(window.opener!==null){
                    ...
                    "<button style=\'float:right;\' onClick=\'window.close();\'>Return to Map</button>";
                }
            });', 'inline');
